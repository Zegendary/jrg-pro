...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = new _vue2.default({
	  ...
	  methods: {
	    ...
	    fetchItem: function fetchItem(argu) {
	      return _storage2.default.fetch(argu) == null ? [] : _storage2.default.fetch(argu);
	    },
	  ...
	  created: function created() {
	    ...
	    window.onbeforeunload = function () {
	      _storage2.default.save('ToDoList', _this3.todoList);
	      _storage2.default.save('NewItem', _this3.newTodo);
	    };
